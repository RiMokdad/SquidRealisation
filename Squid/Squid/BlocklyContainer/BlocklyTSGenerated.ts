// A regener si necessaire et le projet est à re-cloner aussi car il y a eu un prblème lors du premier clone.
...
declare module Blockly {
    ...
    class Block__Class  { 
            ...
            */
             ...
             * parameter : {!Blockly.Workspace} workspace The new block's workspace.
             * parameter : {?string} prototypeName Name of the language object containing
             ...
             * parameter : {!Blockly.Workspace} workspace The workspace to use.
             * parameter : {string} prototypeName The typename of the block.
             */
             ...
             * parameter : {boolean} healStack If true, then try to heal any gap by connecting
             *     the next statement with the previous statement.  Otherwise, dispose of
             *     all children of this block.
             * parameter : {boolean} animate If true, show a disposal animation and sound.
             * parameter : {boolean=} opt_dontRemoveFromWorkspace If true, don't remove this
             ...
             * parameter : {boolean} healStack Disconnect child statement and reconnect stack.
             * parameter : {boolean} bump Move the unplugged block sideways a short distance.
             */
            unplug(healStack: boolean, bump: boolean): void;
    
            /**
             * Returns all connections originating from this block.
             * parameter : {boolean} all If true, return all connections even hidden ones.
             ...
             * return : {Blockly.Block} newParent New parent block.
             */
             ...
             * return : {boolean} deletable True if deletable.
             */
             ...
             * parameter : {boolean} movable True if movable.
             */
             ...
             * parameter : {boolean} editable True if editable.
             */
             ...
             * parameter : {boolean} hidden True if connections are hidden.
             */
            setConnectionsHidden(hidden: boolean): void;
    
            /**
             * Set the URL of this block's help page.
             * parameter : {string|Function} url URL string for block help, or function that
             ...
             * parameter : {string|!Function} newTip Text for tooltip or a parent element to
             ...
             * parameter : {number} colourHue HSV hue value.
             */
            setColour(colourHue: number): void;
    
            /**
             * Returns the named field from a block.
             * parameter : {string} name The name of the field.
            ...
            /**
             * Change the field value for a block (e.g. 'CHOOSE' or 'REMOVE').
             * parameter : {string} newValue Value to be the new field.
             * parameter : {string} name The name of the field.
             * deprecated December 2013
             */
             ...
             * parameter : {boolean} newBoolean True if there can be a previous statement.
             * parameter : {string|Array.<string>|null|undefined} opt_check Statement type or
             ...
             * parameter : {boolean} newBoolean True if there can be a next statement.
             * parameter : {string|Array.<string>|null|undefined} opt_check Statement type or
             *     list of statement types.  Null/undefined if any type could be connected.
             */
             ...
             * parameter : {boolean} newBoolean True if there is an output.
             * parameter : {string|Array.<string>|null|undefined} opt_check Returned type or list
             ...
             * parameter : {boolean} newBoolean True if inputs are horizontal.
             */
             ...
             * parameter : {boolean} disabled True if disabled.
             */
             ...
             * parameter : {boolean} collapsed True if collapsed.
             */
            setCollapsed(collapsed: boolean): void;
    
            /**
             * Create a human-readable text representation of this block and any children.
             * parameter : {number=} opt_maxLength Truncate the string to this length.
             ...
             * parameter : {string} name Language-neutral identifier which may used to find this
             ...
             * parameter : {string=} opt_name Language-neutral identifier which may used to find
             ...
             * JSON description.
             * parameter : {!Object} json Structured data describing the block.
             */
            jsonInit(json: Object): void;
    
            /**
             * Interpolate a message description onto the block.
             * parameter : {string} message Text contains interpolation tokens (%1, %2, ...)
             *     that match with fields or inputs defined in the args array.
             * parameter : {!Array} args Array of arguments to be interpolated.
             * parameter : {=string} lastDummyAlign If a dummy input is added at the end,
             ...
             * parameter : {number} type Either Blockly.INPUT_VALUE or Blockly.NEXT_STATEMENT or
             *     Blockly.DUMMY_INPUT.
             * parameter : {string} name Language-neutral identifier which may used to find this
             *     input again.  Should be unique to this block.
             * return : {!Blockly.Input} The input object created.
             ...
             * parameter : {string} name The name of the input to move.
             * parameter : {?string} refName Name of input that should be after the moved input,
             ...
             * parameter : {number} inputIndex Index of the input to move.
             * parameter : {number} refIndex Index of input that should be after the moved input.
             */
            moveNumberedInputBefore(inputIndex: number, refIndex: number): void;
    
            /**
             * Remove an input from this block.
             * parameter : {string} name The name of the input.
             * parameter : {boolean=} opt_quiet True to prevent error if input is not present.
